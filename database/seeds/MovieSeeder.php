    ...
    public function run()
    {
        ...
        $movies = [
            [
                ...
                "year" => 2001,
                "synopses" => "Uma criança órfã se enrolla em uma escola de magia, onde ele aprende a verdade sobre si mesmo, sua família e o terrível mal que se esconde no mundo mágico.",
                "duration" => "2h32",
            ...
            [
                ...
                "year" => 2002,
                "synopses" => "Um mito antigo parece ser corroborado quando uma misteriosa presença começa a perseguir os corredores da escola mágica, deixando suas vítimas petrificadas.",
                "duration" => "2h41",
                "directors" => "Chris Columbus",
                "writers" => " J.K. Rowling",
                "stars" => "{ {'name': 'Daniel Radcliffe'}, {'name': ' Rupert Grint'}, {'name': 'Emma Watson'}}",
            ...
            [
                ...
                "year" => 2004,
                "synopses" => "Harry está prestes a começar o seu terceiro ano em Hogwarts quando o terrível assassino Sirius Black, um aliado de Voldemort, foge da prisão de Azkaban. Apesar da vigilância, Harry sabe que, cedo ou tarde, Black virá ao seu encontro.",
                "duration" => "2h22",
            ...
            [
                ...
                "year" => 2005,
                "synopses" => "Com sua advertência sobre o retorno de Lord Voldemort, Harry e Dumbledore, são atacados pelas autoridades do mago, enquanto um burocrata autoritário toma o poder lentamente em Hogwarts.",
                "duration" => "2h37",
    		...
    		[
                ...
                "year" => 2009,
                "synopses" => "Harry Potter começa seu sexto ano em Hogwarts, descobre um livro de propriedade do Príncipe Mestiço, e começa a aprender mais sobre o passado sombrio de Voldemort.",
                "duration" => "2h33",
                "directors" => "David Yates",
                "writers" => " J.K. Rowling",
                "stars" => "{ {'name': 'Daniel Radcliffe'}, {'name': ' Rupert Grint'}, {'name': 'Emma Watson'}}",
    		...
    		[
                ...
                "year" => 2010,
                "synopses" => "Harry embarca em uma corrida contra o tempo para destruir as Horcruxes e descobre a existência dos três objetos mais poderosos do mundo mágico: as relíquias da morte.",
                "duration" => "2h26",
                "directors" => "David Yates",
                "writers" => " J.K. Rowling",
                "stars" => "{ {'name': 'Daniel Radcliffe'}, {'name': ' Rupert Grint'}, {'name': 'Emma Watson'}}",
    		...
    		[
                ...
                "year" => 2011,
                "synopses" => "Harry, Ron e Hermione devem escapar a Voldemort e tentar trabalhar em conjunto para localizar e aniquilar os Horcruxes, que contêm pedaços da alma de Voldemort.",
                "duration" => "2h10",
                "directors" => "David Yates",
                "writers" => " J.K. Rowling",
                "stars" => "{ {'name': 'Daniel Radcliffe'}, {'name': ' Rupert Grint'}, {'name': 'Emma Watson'}}",
